...
// 	public ObservationDto mapToDTO(Observation fhirObservation) {
// 		ObservationDto dto = new ObservationDto();

// 		if (fhirObservation.hasId()) {
// 			dto.setId(fhirObservation.getIdElement().getIdPart());
// 		}
...
// 		// Map code
// 		dto.setCode(mapCode(fhirObservation.getCode()));

// 		// Map subject
// 		dto.setSubject(mapSubject(fhirObservation.getSubject()));

// 		// Map effective date time
// 		if (fhirObservation.hasEffectiveDateTimeType()) {
// 			dto.setEffectiveDateTime(fhirObservation.getEffectiveDateTimeType().getValueAsString());
// 		}

// 		// Map value (different types)
// 		mapValue(fhirObservation, dto);

// 		// Map components
// 		dto.setComponent(mapComponents(fhirObservation));

// 		// Map performer
// 		dto.setPerformer(mapPerformer(fhirObservation));

// 		// Map interpretation
// 		if (fhirObservation.hasInterpretation()) {
// 			fhirObservation.getInterpretationFirstRep().getCoding().stream()
// 					.findFirst()
// 					.ifPresent(coding -> dto.setInterpretation(coding.getDisplay()));
// 		}

// 		return dto;
// 	}

// 	private ObservationCode mapCode(CodeableConcept fhirCode) {
// 		if (fhirCode == null) {
// 			return null;
// 		}
...
// 		if (fhirCode.hasCoding()) {
// 			List<ObservationCoding> codings = fhirCode.getCoding().stream()
// 					.map(this::mapCoding)
...
// 		if (fhirCode.hasText()) {
// 			code.setText(fhirCode.getText());
// 		}

// 		return code;
// 	}

// 	private ObservationCoding mapCoding(Coding fhirCoding) {
// 		ObservationCoding coding = new ObservationCoding();

// 		if (fhirCoding.hasSystem()) {
// 			coding.setSystem(fhirCoding.getSystem());
// 		}

// 		if (fhirCoding.hasCode()) {
// 			coding.setCode(fhirCoding.getCode());
// 		}

// 		if (fhirCoding.hasDisplay()) {
// 			coding.setDisplay(fhirCoding.getDisplay());
// 		}

// 		return coding;
// 	}

// 	private ObservationSubject mapSubject(Reference fhirSubject) {
// 		if (fhirSubject == null) {
// 			return null;
// 		}
...
// 		if (fhirSubject.hasReference()) {
// 			subject.setReference(fhirSubject.getReference());
// 		}

// 		if (fhirSubject.hasDisplay()) {
// 			subject.setDisplay(fhirSubject.getDisplay());
// 		}

// 		return subject;
// 	}

// 	private void mapValue(Observation fhirObservation, ObservationDto dto) {
// 		if (fhirObservation.hasValueQuantity()) {
// 			dto.setValueQuantity(mapValueQuantity(fhirObservation.getValueQuantity()));
// 		} else if (fhirObservation.hasValueStringType()) {
// 			dto.setValueString(fhirObservation.getValueStringType().getValue());
// 		} else if (fhirObservation.hasValueCodeableConcept()) {
// 			dto.setValueCodeableConcept(mapValueCodeableConcept(fhirObservation.getValueCodeableConcept()));
// 		}
// 	}

// 	private ObservationValueQuantity mapValueQuantity(Quantity fhirQuantity) {
// 		if (fhirQuantity == null) {
// 			return null;
// 		}

// 		ObservationValueQuantity valueQuantity = new ObservationValueQuantity();

// 		if (fhirQuantity.hasValue()) {
// 			valueQuantity.setValue(fhirQuantity.getValue().doubleValue());
// 		}

// 		if (fhirQuantity.hasUnit()) {
// 			valueQuantity.setUnit(fhirQuantity.getUnit());
// 		}

// 		if (fhirQuantity.hasSystem()) {
// 			valueQuantity.setSystem(fhirQuantity.getSystem());
// 		}

// 		if (fhirQuantity.hasCode()) {
// 			valueQuantity.setCode(fhirQuantity.getCode());
// 		}

// 		return valueQuantity;
// 	}

// 	private ObservationValueCodeableConcept mapValueCodeableConcept(CodeableConcept fhirCodeableConcept) {
...
// 		if (fhirCodeableConcept.hasCoding()) {
// 			List<ObservationCoding> codings = fhirCodeableConcept.getCoding().stream()
// 					.map(this::mapCoding)
// 					.collect(Collectors.toList());
// 			valueCodeableConcept.setCoding(codings);
// 		}

// 		if (fhirCodeableConcept.hasText()) {
// 			valueCodeableConcept.setText(fhirCodeableConcept.getText());
// 		}

// 		return valueCodeableConcept;
// 	}

// 	private List<ObservationComponent> mapComponents(Observation fhirObservation) {
// 		if (!fhirObservation.hasComponent()) {
// 			return null;
// 		}

// 		return fhirObservation.getComponent().stream()
// 				.map(this::mapComponent)
// 				.collect(Collectors.toList());
// 	}

// 	private ObservationComponent mapComponent(Observation.ObservationComponentComponent fhirComponent) {
// 		ObservationComponent component = new ObservationComponent();

// 		// Map component code
// 		if (fhirComponent.hasCode()) {
// 			component.setCode(mapCode(fhirComponent.getCode()));
// 		}

// 		// Map component value (different types)
// 		if (fhirComponent.hasValueQuantity()) {
// 			component.setValueQuantity(mapValueQuantity(fhirComponent.getValueQuantity()));
// 		} else if (fhirComponent.hasValueStringType()) {
// 			component.setValueString(fhirComponent.getValueStringType().getValue());
// 		} else if (fhirComponent.hasValueCodeableConcept()) {
// 			component.setValueCodeableConcept(mapValueCodeableConcept(fhirComponent.getValueCodeableConcept()));
// 		}

// 		return component;
// 	}

// 	private ObservationPerformer mapPerformer(Observation fhirObservation) {
// 		if (!fhirObservation.hasPerformer()) {
// 			return null;
// 		}

// 		Reference performerRef = fhirObservation.getPerformerFirstRep();
// 		ObservationPerformer performer = new ObservationPerformer();

// 		if (performerRef.hasReference()) {
// 			performer.setReference(performerRef.getReference());
// 		}

// 		if (performerRef.hasDisplay()) {
// 			performer.setDisplay(performerRef.getDisplay());
// 		}
